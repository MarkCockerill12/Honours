...
import { isAdOrTracker, recordBlockedRequest, initBlockStats, resetBlockStats } from './adBlockEngine';
...
describe('adBlockEngine', () => {
  ...
  describe('isAdOrTracker', () => {
    it('identifies generic ad domains', () => {
      ...
      expect(isAdOrTracker('https://googlesyndication.com/ads').category).toBe('ads');
    });
