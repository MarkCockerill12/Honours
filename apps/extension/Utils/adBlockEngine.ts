...
export const AD_DOMAINS = [
  ...
  'youtube.com/get_midroll_info', 'googlevideo.com/videoplayback',
  
  // Facebook/Meta
  'facebook.com/tr/', 'facebook.net', 'fbcdn.net/tr', 'connect.facebook.net',
  
  // Amazon
  'amazon-adsystem.com', 'amazonclix.com',
  
  // Ad Networks
  'adnxs.com', 'advertising.com', 'adsrvr.org', 'adroll.com', 'adsafeprotected.com',
  'criteo.com', 'criteo.net', 'casalemedia.com', 'pubmatic.com', 'rubiconproject.com',
  ...
  'twitter.com/i/adsct', 'ads-twitter.com', 't.co/i/adsct',
  'linkedin.com/px/', 'snapchat.com/tr',
  
  // More Ad Networks
  'ad.doubleclick.net', 'pubads.g.doubleclick.net', 'securepubads.g.doubleclick.net',
  'tpc.googlesyndication.com', 'pagead2.googlesyndication.com',
  'media.net', 'advertising.com', 'adtechus.com',
];
...
export const AD_SELECTORS = [
  ...
  '.ytp-ad-text', '.ytp-ad-player-overlay', '.ad-showing',
  '#player-ads', 'ytd-display-ad-renderer', 'ytd-promoted-sparkles-web-renderer',
  'ytd-ad-slot-renderer', 'ytd-banner-promo-renderer',
  
  // Social media ads
  '[data-ad-preview]', '[data-ad-comet-preview]',
  'div[data-testid*="ad"]', 'div[data-testid*="sponsored"]',
...
export const isAdOrTracker = (url: string): { isAd: boolean; category: 'ads' | 'trackers' | 'analytics' | 'social' | 'youtube' | null } => {
